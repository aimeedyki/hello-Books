...
export default {
  ...
  /** @description modifies an existing book information
   *
   * @param {object} req HTTP request object
   * @param {object} res HTTP response object
   *
   * @returns {object} the newly edited book
   */
  modifyBook(req, res) {
  ...
  /** @description displays a single book
    *
    * @param {object} req HTTP request object
    * @param {object} res  HTTP response object
    *
    * @returns {object} a single book
    */
  viewBook(req, res) {
    const bookId = parseInt(req.params.id, 10);
    if (isNaN(bookId)) {
  ...
  /** @description deletes a book from library
   * 
   * @param {object} req HTTP request object
   * @param {object} res HTTP response object
   * 
  ...
  /** @description searches for books that match a search term
   * 
   * @param {object} req HTTP request object
   * @param {object} res HTTP response object
   *
   * @returns {array} an array of books that match the search term
   * @returns {object} pagination details
   */
  searchBooks(req, res) {

...
describe('BookCategorycomponent', () => {
  ...
  test('should call an instance of getPagination function', () => {
    const wrapper = setUp();
  ...
  test('should call an instance of getPages function', () => {
    const wrapper = setUp();
  ...
  test('should call searchCategory action creator when searching a category',
    () => {
      const wrapper = setUp();
  ...
  test(`should return all books in a category if search length is less than 2 
  in the search category function`, () => {
      const wrapper = setUp();
      const searchBookCategorySpy = jest.spyOn(
        wrapper.instance(), 'searchBookCategory'
      );
      ...
      wrapper.instance().searchBookCategory(event);
      expect(searchBookCategorySpy).toHaveBeenCalledTimes(1);
      expect(props.getBooksByCategory).toHaveBeenCalled();
    });

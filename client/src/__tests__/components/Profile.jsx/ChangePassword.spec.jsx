...
const passwordChange = jest.fn(() => Promise.resolve(true));
...
describe('ChangePassword component', () => {
  ...
  test('should call handleChange when there is a change in any fields', () => {
    const wrapper = setUp();
    ...
    expect(wrapper.instance().state.newPassword).toBe('hiheyho');
  });
  test('should call changePassword user when form is submited', () => {
    ...
    expect(wrapper.instance().props.passwordChange).toHaveBeenCalled();
  });
